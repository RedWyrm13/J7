...
for each of the three previously mentioend circuit families, Clifford, Clifford$+T$, and IQP circuits.
...
qubits. For the Clifford family of circuits, each gate has an equal chance of being applied. For the 
Clifford$+T$ family, the gates have chances of being applied as outlined in Table\ref{tab:cliffordT_gate_distros}.
We emphasized the T gate count in Clifford$+T$ to help ensure it is distinguished from the Clifford family.
...
gate set used, is that the operator $H^{\bigotimes n}$ is applied and the beginning and end of the circuit
